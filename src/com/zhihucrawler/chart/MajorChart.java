...
public class MajorChart {
	...
	public static JFreeChart createChart(String title, CategoryDataset dataset) {
		...
		JFreeChart chart = ChartFactory.createBarChart(title, "专业分布", "用户数量", dataset, PlotOrientation.VERTICAL,false, false, false);
...
//		renderer.setBasePositiveItemLabelPosition(new ItemLabelPosition(ItemLabelAnchor.OUTSIDE12, TextAnchor.CENTER_LEFT));
	...
	public void generateLocationChart(List<Object[]> list) {
		try {
			...
			JFreeChart chart = createChart(Const.MAJOR_TITLE, dataset);
			OutputStream outputStream = new FileOutputStream("chart/major.jpeg");
	...
	public static void main(String[] args) {
		...
		List<Object[]> list = crawlerDB.countMajorRatio();
		MajorChart chart = new MajorChart();
