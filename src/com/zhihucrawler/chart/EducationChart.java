...
public class EducationChart {
	...
	public static JFreeChart createChart(String title, CategoryDataset dataset) {
		...
		JFreeChart chart = ChartFactory.createBarChart(title, "院校分布", "用户数量", dataset, PlotOrientation.VERTICAL,false, false, false);
...
//		renderer.setBasePositiveItemLabelPosition(new ItemLabelPosition(ItemLabelAnchor.OUTSIDE12, TextAnchor.CENTER_LEFT));
	...
	public void generateLocationChart(List<Object[]> list) {
		try {
			...
			JFreeChart chart = createChart(Const.EDUCATION_TITLE, dataset);
			OutputStream outputStream = new FileOutputStream("chart/education.jpeg");
	...
	public static void main(String[] args) {
		...
		List<Object[]> list = crawlerDB.countEducationRatio();
		EducationChart chart = new EducationChart();
